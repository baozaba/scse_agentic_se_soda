...
output is a complete Python module containing a decide_next_move(state)
function, generated by Qwen itself.
"""
...
SYSTEM_PROMPT = (
    ...
    "The code MUST define a function named decide_next_move with this exact "
    "signature:\n"
    "def decide_next_move(state):\n"
    "\n"
    "Where:\n"
    '  - state is a dict the robot receives from its sensors, containing '
    "exactly these six boolean keys: \"goal_ahead\", \"goal_on_left\", "
    "\"goal_on_right\", \"front_blocked\", \"left_blocked\", "
    "\"right_blocked\".\n"
    '  - the function returns exactly one of the strings "FORWARD", "LEFT", '
    '"RIGHT" or "STOP".\n\n'
    "The function MUST implement this exact algorithm:\n"
    "1. If goal_ahead is True and front_blocked is False, return FORWARD.\n"
    "2. If goal_on_left is True and left_blocked is False, return LEFT.\n"
    "3. If goal_on_right is True and right_blocked is False, return RIGHT.\n"
    "4. Otherwise, check FORWARD, LEFT and RIGHT in that order and return the "
    "first direction that is not blocked.\n"
    "5. If every direction is blocked, return STOP.\n\n"
    "The function MUST use the goal_* keys in the state -- do NOT ignore them.\n\n"
...
def validate_code(data):
    ...
    if "decide_next_move" not in code:
        print("Error: code must define a function named decide_next_move")
        return None

    if "state" not in code:
        print("Error: code must use the state parameter")
        return None
